return {
                            ...
                            analysis = {
                                ...
                                diagnosticSeverityOverrides = {
                                    ...
                                    diagnosticSeverityOverrides = {
                                        ...
                                        reportMissingFunctionDocstring = "information", -- Docstring de função faltando
    ...
    -- Adicione este para garantir que o linting está habilitado
    {
        "mfussenegger/nvim-lint",
        optional = true,
        opts = {
            linters_by_ft = {
                python = { "ruff" }, -- ou "flake8", "ruff", etc.
            },
        },
    },
